                ...
                <template>
                    <el-table ref="filterTable" :data="toDoEventsList" style="width: 100%">
                        ...
                        <el-table-column prop="name" label="操作" width="100" fixd="right">
                            <template slot-scope="scope">
                                <el-button @click="toWaitToDo(scope.row)">处理</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </template>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 获取待办事件数据
            getWaitToEventsInfo() {
                console.log("getWaitToEventsInfo");
            ...
            getAdminEvents() {
                ...
                this.$axios.post(this.myHttp + '/user/testDeletePermission', {
                        "roleName": "test"
                    })
                    .then(response => {
                        // 处理响应数据
            ...
            uploadExcel(content) {
                ...
                this.$axios.post(this.myHttp + '/api/uploadEvents', fileFormData)
                    .then(response => {
                        console.log("上传成功");
                    })
                    .catch(error => {
